...
16. **マルチテンポラル拡張を採用（確定・2026-07-01）。** 元178枚＋ステップ2aでTRUE確認された地点について、別時期のNICFIモザイクを地点あたり最大4追加（最大5倍）取得しYOLO学習データを増強する。地点単位train/val分割・視認可能時期限定・多様性優先選定が条件。詳細はCONCEPT_NOTE.md「ステップ3c」参照
